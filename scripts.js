...
new Vue({
  ...
  methods: {
    ...
    getVeriyingSlabBill(unit) {
      //incrementing charge
      if (unit > 200) {
        this.split.push({ unit: unit - 200,unitCost: 7.6});    
        return (unit - 200) * 7.6 + this.getVeriyingSlabBill(200);
      }
      if (unit > 150) {
        this.split.push({ unit: unit - 150,unitCost: 6.4});  
        return (unit - 150) * 6.4 + this.getVeriyingSlabBill(150);
      }
      if (unit > 100) {
        this.split.push({ unit: unit - 100,unitCost: 4.8});  
        return (unit - 100) * 4.8 + this.getVeriyingSlabBill(100);
      }
      if (unit > 50) {
        this.split.push({ unit: unit - 50,unitCost: 3.7});  
        return (unit -50) * 3.7 + this.getVeriyingSlabBill(50);
      }
      this.split.push({ unit: unit,unitCost: 3.15});  
      return unit * 3.15;
    },
    getBillAmount(unit) {
      //fixed charge
      ...
      if (unit > 500) {
        this.split.push({ unit: unit,unitCost: 7.9});  
        return unit * 7.9;
      }
      if (unit > 400) {
        this.split.push({ unit: unit,unitCost: 7.1});  
        return unit * 7.1;
      }
      if (unit > 350) {
        this.split.push({ unit: unit,unitCost: 6.9});  
        return unit * 6.9;
      }
      if (unit > 300) {
        this.split.push({ unit: unit,unitCost: 6.6});  
        return unit * 6.6;
      }
      if (unit > 250) {
        this.split.push({ unit: unit,unitCost: 5.8});  
        return unit * 5.8;
      }
